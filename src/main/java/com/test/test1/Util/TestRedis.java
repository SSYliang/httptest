...
import com.test.test1.Util.RedisUtil;
...
public class TestRedis {
    ...
    public void testString(){
        ...
        jedis.set("height","180");
        System.out.println("普通数据：" + "name = " + jedis.get("name") + ";    " + "height = " + jedis.get("height"));
        //拼接字符串
        jedis.append("name",".com");
        System.out.println("拼接字符串：" + "name = " + jedis.get("name") + "    ");
        //删除数据
        jedis.del("name");
        System.out.println("删除数据：" + "name = " + jedis.get("name") + "    ");
        //设置多个键值对
        jedis.mset("name","yc","age","22","qq","19330");
        jedis.incr("age");//加1操作
        System.out.println("键值对：" + jedis.get("name") + "-" + jedis.get("age") + "-" + jedis.get("qq"));
    }
